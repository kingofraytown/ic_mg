...
public class SMissileLauncher : MonoBehaviour {
    ...
    public void FireMissile()
    {
        ...
        for (int i = 0; i < missileArraySize; i++)
        {
            ...
            {
                missileArray[i].transform.position = new Vector3(gameObject.transform.position.x + 30,gameObject.transform.position.y,gameObject.transform.position.z);
                missileArray[i].transform.rotation = gameObject.transform.rotation;
                //missileArray[i].transform.localEulerAngles = new Vector3(0f, 90f, 0f);
