...
*/
    ...
    public delegate void SMissileDelegate(missileState newState);
    public static event SMissileDelegate smissleEvent;
    ...
    void Fire()
    {
        ...
        homingMissile.transform.LookAt(new Vector3(target.position.x + 700f, target.position.y, target.position.z));
    }
    ...
    void FixedUpdate()
    {
        ...
        {
            smissleEvent(missileState.miss);
            destroyMissile();
